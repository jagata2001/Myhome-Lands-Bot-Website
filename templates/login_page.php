...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href="./templates/css/login.css" rel="stylesheet" id="bootstrap-css">
  </head>
      ...
      <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <div class="fadeIn first">
            <img src="./templates/images/avatar.png" id="icon" alt="User Icon" />
          </div>
      ...
      if(username.value.length == 0){
        ...
        .then(data => {
          if (data != "Successfully logged in"){
            message.firstChild.textContent = data;
            submit.disabled = false;
          }else{
            location.reload();
          }
        ...
        .catch((error) => {
          ...
          submit.disabled = false;
                ...
                <div style="display:none" id="top-ge-counter-container" data-site-id="100616"></div>
